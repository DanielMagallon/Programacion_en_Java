...
public class Saludo
{
	...
	/*
	 * Si no es jefe, el empleado va a quedar esperando a que llegue el jefe Se hace
	 * wait de el hilo que esta corriendo y se bloquea, hasta que se le avise que ya
	 * puede saludar
	 */

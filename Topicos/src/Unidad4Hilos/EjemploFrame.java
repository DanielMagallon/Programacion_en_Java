...
public class EjemploFrame extends JFrame {
	...
	private void initComponents(){
		...
		jbIncrementarSinSwingWorker.addActionListener(new IncrementarSinSwingWorkerAction(this));
		
		jbIncrementarSinSwingWorker.setText("Incrementar sin swing worker");
		jbIncrementarConSwingWorker.addActionListener(new IncrementarConSwingWorkerAction(this));
